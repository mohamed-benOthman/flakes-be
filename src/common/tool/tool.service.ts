...
export class ToolService {
  ...
  public static getCurrentDateWithFormat(
    sep: string,
    sep_hour: string,
    displayHour: boolean
  ): string {
  ...
  public static sendMailConfirmation(
    userfrom: UserMailDto,
    userto: UserMailDto,
    type: number,
    token: string
  ): string {
  ...
  public static sendResetEmailSuccess(
    userfrom: UserMailDto,
    userto: UserMailDto
  ): string {
    const Mailjet = require("node-mailjet").connect(
  ...
  public static sendValidationMail(
    userfrom: UserMailDto,
    userto: UserMailDto,
    code: string
  ) {
    ...
    console.log(
      "sendMail userfrom:" + userfrom.email + " userto:" + userto.email
    );
    const Mailjet = require("node-mailjet").connect(
      MailJetKey,
      MailJetSecrete
